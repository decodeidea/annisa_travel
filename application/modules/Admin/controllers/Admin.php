...
class Admin extends DC_controller {
	...
	function summernoteupload(){
     ...
     if(move_uploaded_file($_FILES['file']['tmp_name'],'assets/uploads/summernote/'.$_FILES['file']['name'])){
     $tmp='images/'.$_FILES['file']['name'];
     $new = 'assets/uploads/summernote/'.$_FILES['file']['name']; //adapt path to your needs;
     echo base_url().'assets/uploads/summernote/'.$_FILES['file']['name'];
