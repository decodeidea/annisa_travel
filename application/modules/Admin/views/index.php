...
<div class="container">
  ...
  <div class="row login-container animated fadeInUp">
        <div class="col-md-7 center tiles white no-padding">
     <div class="text-center div-logo"> 
    
         <img src="<?php echo base_url() ?>assets/uploads/settings/<?php echo $this->appearance->logo ?>" width="30%" >
    ...
    <div class="tiles grey p-t-20 p-b-20 text-black">
      ...
      <br>
        <div class="col-md-7 center white no-padding">
