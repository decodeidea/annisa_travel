          ...
          <div class="featured row">
            <div class="ulasan">
              ...
              <form id="" action="#" method="POST" class="custom-form-style-1 form-ulasan">
                ...
                <div class="row">
                  <div class="col-md-12 text-center">
                    <input type="submit" value="SUBMIT REVIEW" class="btn btn-primary custom-btn-style-1 text-uppercase" data-loading-text="Loading...">
                  </div>
                </div>
              </form>
                  ...
                  <div class="comment">
                    ...
                    <div class="comment-block">
                      <span class="comment-by">
                        ...
                        <span>Review</span>
                        <span id="stars" class="starrr rev" data-rating='5'></span>
