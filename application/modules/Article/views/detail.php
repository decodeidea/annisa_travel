 <div role="main" class="main">
      		<div class="header-article" style="background: url(<?php echo base_url() ?>assets/theme/img/kurma.jpg);">
      			<div class="container">
      				<div class="container-fluid">
      					<h4>ARTIKEL</h4>
		      			<h1>Memetik Kurma di Madinah <br>bersama Jamaah Annisa Travel</h1>
      				</div>			
      		</div>	
      		</div>
          <section>
      ...
      <div class="head-rekomendasi">
          ...
          <div class="col-sm-4 col-md-4">
            <a href="<?php echo base_url() ?>product/detail" style="text-decoration: none;"  class="text-decoration-none">
