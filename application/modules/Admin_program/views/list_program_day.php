     ...
     <div class="row-fluid">
        <div class="span12">
          <div class="grid simple ">
            ...
            <div class="grid-body ">
              <a href="<?php echo site_url() ?>/<?php echo $controller ?>/<?php echo $function ?>_form?id_program=<?php echo $this->uri->segment(4) ?>" style="position: absolute; left: 130px; z-index: 2"><button data-toggle="modal" data-target="#add_training" class="btn btn-primary">Add</button></a>
              <table class="table" id="list_data2" >
               ...
               <?php
                ...
                ?>
                  <tr >
                    <td><?php echo $no ?></td>
                    <td><?php echo tanggal_indo($data->day) ?></td>
                    <td>
