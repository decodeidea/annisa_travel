                ...
                ?>
                  <tr >
                    ...
                    <td class="text-center">
                      <button class="btn btn-<?php if($data->featured==1){echo"info";}else{echo"danger";}?>" onclick="featured_destination(<?php echo $data->id ?>,<?php if($data->featured==1){echo"0";}else{echo"1";} ?>)" id="featured_<?php echo $data->id ?>" data-id="<?php echo $data->id ?>"><?php if($data->featured==0){echo"No";}else{echo"Yes";} ?></button>
                    </td>
                    <td>
