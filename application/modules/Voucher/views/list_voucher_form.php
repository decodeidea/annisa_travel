                  ...
                  <div class="row">
                    <div class="col-md-8 col-sm-8 col-xs-8">
                      <div class="form-group">
                        ...
                        <div class="controls">
                          <input type="text" required name="kode_voucher" class="form-control" value="<?php if(isset($data)){ echo $data->kode_voucher; } ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="controls">
                          <input type="text" required name="amount" class="form-control" value="<?php if(isset($data)){ echo $data->amount; } ?>">
                        </div>
                      </div>
