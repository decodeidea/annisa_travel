 <div role="main" class="main">
      		<div class="header-article" style="background: url(<?php echo base_url() ?>assets/uploads/banner/<?php echo $data->id ?>/<?php echo $data->images ?>); background-size: cover">
      			<div class="container">
      				<div class="container-fluid">
      					<h4 style="text-transform: uppercase;"><?php echo $data->category ?></h4>
          ...
          <div class="row">
            ...
            <div class="content-article">
              <?php echo str_replace("<img", "<img style='width:100%!important;'", $data->description)   ?>
              ...
              <span class="thumb-info thumb-info-side-image thumb-info-side-image-custom thumb-info-no-zoom thumb-info-no-zoom thumb-info-side-image-custom-highlight">
                ...
                <span class="thumb-info-caption">
                  <span class="thumb-info-caption-text p-xl">
                    ...
                    <p style="min-height: 100px;"><?php echo substr(strip_tags($key->summary),0,100) . "..."; ?></p>
