...
<?php } ?>
                ...
                <div class="grid-body no-border">
                  <div class="row">
                    <div class="col-md-8 col-sm-8 col-xs-8">
                      ...
                      <div class="form-group">
                        <label class="form-label">Images (324x260)</label>
                        

                        <div class="box">
          <input type="file" name="images" id="file-7" <?php if(!isset($data)){ echo"required";}  ?> class="inputfile" accept="image/*" onchange="loadFile(event)" />
        ...
        <img id="output" class="ouput_image_input" <?php if($data){ ?> src="<?php echo base_url() ?>assets/uploads/static-page/<?php if($data->images==''){echo"default.jpg";}else{echo $data->id."/".$data->images;} }?> " />
                      ...
                      <div class="form-group">
                        <label class="form-label">Embed Youtube</label>
                        <div class="controls">
                          <input type="text" name="source" class="form-control" value="<?php if(isset($data)){ echo $data->id_embed; } ?>">
                        </div>
                      </div>
