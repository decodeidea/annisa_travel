                  ...
                  <div class="row">
                    <div class="col-md-8 col-sm-8 col-xs-8">
                      <div class="form-group">
                        ...
                        <div class="controls">
                          <input type="text" name="first_name" class="form-control" value="<?php if(isset($data)){ echo $data->first_name; } ?>">
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="controls">
                          <input type="text" name="last_name" class="form-control" value="<?php if(isset($data)){ echo $data->last_name; } ?>">
                        </div>
                      </div>
        ...
        <img id="output" class="ouput_image_input" <?php if($data){ ?> src="<?php echo base_url() ?>assets/uploads/user-admin/<?php if($data->photo==''){echo"default.jpg";}else{echo $data->id."/".$data->photo;} }?> " />
        </div>
                       <div class="form-group">
                        <label class="form-label">User Groups</label>
                        <div class="controls">
                          <select required class="form-control" name="user_group">
                          <option value="">--select groups--</option>
                          <?php foreach ($groups as $key) { ?>
                          <option <?php if( $data and $key->id== $data->user_group){echo"selected";} ?> value="<?php echo $key->id ?>"><?php echo $key->name_group ?></option>
                         <?php } ?>
                          </select>
                        </div>
                      </div>
