 <div role="main" class="main">
          <div class="header-article" style="background: url(<?php echo base_url() ?>assets/uploads/experience/<?php echo $data->id ?>/<?php echo $data->images ?>); background-size: cover">
            <div class="container">
          ...
          <div class="link pull-right">
            ...
            <div class="content-article">
              <?php echo str_replace("<img", "<img style='width:100%!important;'", $data->your_story)   ?>
