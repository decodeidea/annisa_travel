      ...
      <div role="main" class="main">
          <div class="header-article" style="background: url(<?php echo base_url() ?>assets/theme/img/kurma.jpg);">
            <div class="container">
          ...
          <div class="row">
            ...
            <div class="content-article">
              ...
              <img src="<?php echo base_url() ?>assets/theme/img/annisa-banner.jpg" width="100%">
        ...
        <div class="row">
          ...
          <div class="featured row">
            ...
            <div class="col-md-3 pull-right">
              <div class="sidebar">
                <h2>Experience Populer</h2>
                <div class="sidebar-article">
                  <img src="<?php echo base_url() ?>assets/theme/img/sidebar-content.png" width="100%">
                  <span>Jalan-jalan ke Dubai hanya Rp.1000,-</span>
                </div>
                <div class="sidebar-article">
                  <img src="<?php echo base_url() ?>assets/theme/img/sidebar-content.png" width="100%">
                  <span>Kiat-kiat Menjaga Stamina selama Beribadah Umroh</span>
                </div>
                <div class="sidebar-article">
                  <img src="<?php echo base_url() ?>assets/theme/img/sidebar-content.png" width="100%">
                  <span>Cara Pergi haji di umur 20 tahun</span>
                </div>
                <div class="sidebar-article">
                  <img src="<?php echo base_url() ?>assets/theme/img/sidebar-content.png" width="100%">
                  <span>Jalan-jalan ke Dubai hanya Rp.1000,-</span>
