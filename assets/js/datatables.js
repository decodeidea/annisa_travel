...
$(document).ready(function() {
    ...
    var oTable = $('#example2').dataTable( {
	 ...
	 var oTable3 = $('#list_data').dataTable( {
	 ...
	 if($("#language").val()=='en'){
	$("div.toolbar").html('<div class="table-tools-actions"><a id="add_button" href="'+$('#site_url').val()+"/"+$('#controller').val()+"/"+$('#method').val()+'_form/"><button class="btn btn-primary" style="margin-left:12px">Add</button></a></div>');
	}else{
	...
	$('#list_data_wrapper .dataTables_filter input').addClass("input-medium ");
    $('#list_data_wrapper .dataTables_length select').addClass("select2-wrapper span12"); 
